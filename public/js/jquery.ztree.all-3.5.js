...
(function($){
	...
	_initNode = function(setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
		...
		n.level = level;
		n.tId = n.NotebookId; // setting.treeId + "_" + (++r.zId); // life 改变tid生成规格, 直接用notebookId
		// n.tId = setting.treeId + "_" + (++r.zId); // life 改变tid生成规格, 直接用notebookId
	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.ICON,
				...
				"' style='", view.makeNodeIcoStyle(setting, node), "'></span><span class='tree-title' id='", node.tId, consts.id.SPAN,
				"'>",name,"</span>");
		},
